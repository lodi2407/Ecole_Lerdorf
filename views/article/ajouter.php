...
<div class="container">
    <form method="post" action="" enctype="multipart/form-data"> 
        <div class="form-group col-5">
            ...
            <input type="text" class="form-control" name="titre" aria-describedby="" placeholder="" required>
        </div>
        <div class="form-group col-5">
            <label for="date">Date</label>
            <input type="date" class="form-control" name="date" aria-describedby="" placeholder="" required>
        </div>
        <div class="form-group col-10">
            <label for="contenu">Contenu</label>
            <textarea type="text" class="form-control" name="contenu" aria-describedby="" placeholder="" rows="8" required></textarea>
        </div>
